...
<%
   ...
   String sDownloadPath = context.getRealPath(savePath); //다운로드를 할때도 업로드 디렉토리 절대경로를 구해와야함
   ...
   try{
   		...
   		File oFile = new File(sFilePath); //File 객체 생성

   		FileInputStream in = new FileInputStream(sFilePath); // 읽어 오는 입력스트림 생성
